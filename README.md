...
- world0 and world1 will each contain a *.tim file for landmarks, one larger *.bin file for the terrain tileset data and four smaller *.bin files for its palettes/CLUTs
