...
The the area of visibility (no fog of war) could be located by using that representation of the map. A an array of sequential words was pasted onto that area.
