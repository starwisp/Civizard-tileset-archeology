...
In the Japanese texts of Civizard, several systems of characters can be used: Hiragana, Katakana, Kanji, letters of the western/Latin alphabet, and western numerals. Studying the suspected font image, we can determine the font file contains Hiragana, Katakana, western letters and western numerals; most Kanji are still missing.
If this is indeed the font image, the game most likely picks the characters from the font file and puts them into texts such as the one below. According to google lens, the Kanji there seem to describe units, buildings and the like. Unfortunately the machine translation only gives a very rough translation and neither of us is fluent in Japanese, so we have to wait till we can dive a deeper into this and also get confirmation from a Japanese speaker. So another possiblity is that the file below is also part of the font but for certain Kanji. We also will probably not get around decompressing all the bmf files in order to find the full font including the Kanji.   
