...
In the texts of Civizard, several systems of characters can be used: Hiragana, Katakana, Kanji, letters of the western/Latin alphabet, and western numerals. Studying the suspected font image, we can determine the font file contains Hiragana, Katakana, western letters in the expected order, and special symbols such as cursor arrows; most Kanji and all western numerals are missing. The font's characters have the right size, so it is most probably the right font. If this is indeed the font image, the game most likely picks the characters from the file and puts them into texts such as the one below.  
